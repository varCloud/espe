                    ...
                    <tbody>
                        ...
                        while ($row = $sql->fetch_array($res)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?= $row["texto_secundario"] ?>
                                </td>                                                               
                                <td>
                                    <!--<a href="#">Editar - </a>--> 
                                    <a href="eliminarBanner.php?id=<?= $row["id_foto_banner"] ?>">Eliminar - </a> 
                                    <a href="editarBanner.php?id=<?= $row["id_foto_banner"] ?>">Editar </a> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" id="formBanner" action="accionAltaBanner.php" enctype="multipart/form-data" method="POST">

                            <div class="form-group">
                                <label for="exampleInputEmail1">Texto principal</label>
                                <textarea class="form-control" name="texto_principal" id="texto_principal"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Texto secundario</label>
                                <textarea class="form-control" name="texto_secundario" id="texto_secundario"></textarea>
                            </div>
                            ...
                            <button type="submit" id="btnGuardar" class="btn btn-primary">Guardar banner</button>
