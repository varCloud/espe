                    ...
                    <tbody>
                        ...
                        while ($row = $sql->fetch_array($res)) {
                            ...
                            <tr>
                                ...
                                <td>                                    
                                    <img src="<?= $row["foto"] ?>" width="30%" />
                                </td>                                                                                             
                                <td>
                                    <!--<a href="#">Editar - </a>--> 
                                    <a href="eliminarGaleria.php?id=<?= $row["id_imagen"] ?>">Eliminar - </a> 
                                    <a href="editarGaleria.php?id=<?= $row["id_imagen"] ?>">Editar </a> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" id="formBanner" action="accionAltaGalery.php" enctype="multipart/form-data" method="POST">
                            <div class="form-group">
                                <label for="exampleInputFile">Foto Galeria</label>
                                <input type="file" id="foto" name="foto">
                                <p class="help-block"></p>
                            </div>                            
                            <button type="submit" id="btnGuardar" class="btn btn-primary">Guardar Galeria</button>
